...
function iterativeFibonacci(n){
  /// Start an array with the first two numbers in the sequence.
  let series = [0, 1];
  /// Going from the third number in the sequnce to the index desired.
  for(let i = 2; i <= n; i++){
    /// Keep pushing a the sum of the previous two elements in the sequence.
